package com.suporte_tecnico.log;
...
// Eu mantive os cometários do professor Gabriel que foram de grande valor.

public class Log {
	public Logger logger;
	FileHandler fh;

	//Verifica se o arquivo de log já existe, senão será criado
